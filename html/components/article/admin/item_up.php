<?php
// DAN 2012
// Поднимаем позицию статьи $admin_d2 = $d[2];
...
// если это не наша статья и если порядок этой статьи совпадает с будущим порядком нашей статьи - увеличиваем его на 1
	if ($item_id_ord != $item_id && $item_ordering_ord == $item_ordering-1) {$item_ordering_ord++;}	
	// если это наша статья - то уменьшаем  его порядок на 1
