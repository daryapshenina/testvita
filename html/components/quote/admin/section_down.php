...
$num = mysql_query("SELECT * FROM `menu` WHERE `menu_type` = '$menu_type' AND `id_com`='$id_com' AND `component`='quote' AND `p1` = 'section' LIMIT 1") or die ("Невозможно сделать выборку из таблицы - 1");
