...
$menu_update_sql = "UPDATE `menu` SET `pub` = '1' WHERE `id_com` = '$id_com' AND `component` = 'quote' AND `p1` = 'section';";
	
$sql_update = mysql_query($menu_update_sql) or die ("Невозможно обновить данные 2");	


// Обновляем данные в таблице "com_quote_section"
$section_update_sql = "UPDATE `com_quote_section` SET `pub` = '1' WHERE `id` = '$id_com'";
