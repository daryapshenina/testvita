...
$menu_update_sql = "UPDATE `menu` SET `pub` = '0' WHERE `id_com` = '$id_com' AND `component` = 'shop' AND `p1` = 'section';";
	
$sql_update = mysql_query($menu_update_sql) or die ("Невозможно обновить данные 2");	


// Обновляем данные в таблице "com_shop_section"
$section_update_sql = "UPDATE `com_shop_section` SET `pub` = '0' WHERE `id` = '$id_com'";
