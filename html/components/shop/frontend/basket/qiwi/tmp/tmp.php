	...
	<div align="center">
		<div class="shop_basket_qiwi_form">
			<table class="shop_basket_qiwi_tab">
				<tr>
					<td width="50%"><img border="0" src="/components/shop/frontend/tmp/images/qiwi_logo.jpg"></td>
				...
				<tr>
					<td colspan="2" class="shop_basket_qiwi_invoice"><div align="center"><a href="/shop/basket/qiwihelp" target="blank">Как платить через QIWI кошелёк или в терминале QIWI</a></div></td>
				</tr>
				<tr>
					<td colspan="2"><hr/></td>
				</tr>
				...
				<tr>
					...
					<td>'.$summa.' '.$shopSettings->currency.'<input type="hidden" name="summ" value="'.$summa.'"></td>
				</tr>
				<tr>
					<td colspan="2"><hr/></td>
				</tr>
