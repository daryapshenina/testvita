		...
		<div style="padding:0px 0px 20px 0px">В ближайшее время менеджер нашей компании свяжется с Вами по телефону '.$tel.'.<br />На Ваш электронный адрес отправлено письмо с содержимым заказа.</div>
			<table class="basket-item-tab">
				<tr>
					...
					<td class="basket-item-price"><b>Цена, '.$shopSettings->getValue('currency').'</b></td>
...
{
	if ($lico == 1){$lico_out = $fiz_lico;}
	if ($lico == 2){$lico_out = $ur_lico;}
...
<table style="width:600px; border-collapse:collapse; background-color:#ffffff">
	<tr>
		...
		<td style="padding:10px; border:solid; border-width:1px; border-color:#dedede; width:75px; vertical-align:middle; text-align:center;"><b>Цена, '.$shopSettings->getValue('currency').'</b></td>
