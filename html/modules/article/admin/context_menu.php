...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_article";
		var contextmenu_module_article = [
			["admin/modules/article/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_article);
	});
</script>
';
