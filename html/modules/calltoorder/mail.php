...
if ($cto_name != '' and $cto_phone != '')
{
	...
	$mail_message = '<p><b>'.LANG_M_CALLTOORDER_NAME.':</b> '.$cto_name.'</p><p><b>'.LANG_M_CALLTOORDER_PHONE.':</b> '.$cto_phone.'</p>';

	// SUBJECT тема
	$subject = LANG_M_CALLTOORDER_ORDERING_CALL." www.".$site." ";
	...
	$mail_message_sent = $mail_message.'<p><b>'.LANG_M_CALLTOORDER_DATE.':</b> '.$data.'</p>';
