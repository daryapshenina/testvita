...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_circle";
		var contextmenu_module_circle = [
			["admin/modules/circle/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_circle);
	});
</script>
';
