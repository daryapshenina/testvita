...
class ModulesAdmin
{
	public function __construct($_id)
	{
		...
		$stmt = $db->prepare("SELECT * FROM modules WHERE module = 'icon' AND id = :id");
	...
	public function effect($_value)
	{
		...
		return 
		'<tr>
			<td style="width:200px;">'.LANG_M_EFFECTS_APPEARANCE.'</td>
			<td>
				<div>
	...
	public function padding($_value)
	{
