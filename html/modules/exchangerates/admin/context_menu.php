...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_exchangerates";
		var contextmenu_module_exchangerates = [
			["admin/modules/exchangerates/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_exchangerates);
	});
</script>
';
