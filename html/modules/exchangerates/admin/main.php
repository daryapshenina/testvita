...
if($d[3] == 'add'){include $root."/modules/exchangerates/admin/add.php"; exit;}
...
if ($d[4] == 'update'){include $root."/modules/exchangerates/admin/update.php";}
else {include $root."/modules/exchangerates/admin/edit.php";}
