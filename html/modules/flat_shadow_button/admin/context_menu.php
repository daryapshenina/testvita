...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_flat_shadow_button";
		var contextmenu_module_flat_shadow_button = [
			["admin/modules/flat_shadow_button/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_flat_shadow_button);
	});
</script>
';
