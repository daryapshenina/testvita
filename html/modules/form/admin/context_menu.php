...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_form";
		var contextmenu_module_form = [
			["admin/modules/form/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_form);
	});
</script>
';
