...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_icon";
		var contextmenu_module_icon = [
			["admin/modules/icon/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_icon);
	});
</script>
';
