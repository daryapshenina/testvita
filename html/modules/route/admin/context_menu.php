...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_route";
		var contextmenu_module_route = [
			["admin/modules/route/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_route);
	});
</script>
';
