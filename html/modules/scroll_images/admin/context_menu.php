...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_scroll_images";
		var contextmenu_module_scroll_images = [
			["admin/modules/flat_rotate/add", "contextmenu_add", "Добавить модуль"],		
		...
		contextmenu(class_name, contextmenu_module_scroll_images);
	});
</script>
';
