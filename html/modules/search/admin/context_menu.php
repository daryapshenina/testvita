...
<script type="text/javascript">
	DAN_ready(function()
	{
		class_name = "contextmenu_module_search";
		var contextmenu_module_search = [
			["admin/modules/search/add", "contextmenu_add", "Добавить модуль"],
		...
		contextmenu(class_name, contextmenu_module_search);
	});
</script>
';
